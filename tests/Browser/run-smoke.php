...
try {
    ...
    try {
        ...
        foreach ([__DIR__ . '/smoke.php', __DIR__ . '/runtime-lifecycle.php', ...array_map(static fn(string $name): string => "$root/examples/$name.php", ['01_page_open', '02_page_screenshot', '03_browserless'])] as $script) {
