...
try {
    ...
    try {
        ...
        $scripts = [__DIR__ . '/smoke.php', __DIR__ . '/static-api.php', __DIR__ . '/plugins.php', __DIR__ . '/runtime-lifecycle.php', __DIR__ . '/failure-boundaries.php', __DIR__ . '/streams.php', __DIR__ . '/recording.php', __DIR__ . '/large-payload.php', ...array_map(static fn (string $name): string => "$root/examples/$name.php", ['01_page_open', '02_page_screenshot', '04_form_intercept', '05_video_stream'])];
