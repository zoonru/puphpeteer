...
try {
    ...
    try {
    check($browser instanceof Nesk\Puphpeteer\Puppeteer\Browser && $browser->connected, 'Typed connected Browser');
    ...
    check($handle instanceof Nesk\Puphpeteer\Puppeteer\JSHandle && $handle->jsonValue() === ['answer'=>42], 'JSHandle');
    ...
    check($element instanceof Nesk\Puphpeteer\Puppeteer\ElementHandle && $element instanceof Nesk\Puphpeteer\Puppeteer\JSHandle, 'Selection and inheritance');
    ...
    check($page->mainFrame() instanceof Nesk\Puphpeteer\Puppeteer\Frame, 'Frame');
    check($page->keyboard instanceof Nesk\Puphpeteer\Puppeteer\Keyboard && $page->keyboard === $page->keyboard, 'Keyboard property identity');
    check($page->mouse instanceof Nesk\Puphpeteer\Puppeteer\Mouse, 'Mouse property');
