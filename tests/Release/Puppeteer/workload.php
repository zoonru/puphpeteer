    ...
    for ($cycle = 0; $cycle < $cycles; $cycle++) {
        ...
        try {
            ...
            if ($cycle % 10 === 0) {
                ...
                } finally { if (is_file($outputPath)) { unlink($outputPath); } }
        ...
        $counts['fileHandles'] = $filesystem === null ? 0 : count((new ReflectionProperty($filesystem, 'handles'))->getValue($filesystem));
