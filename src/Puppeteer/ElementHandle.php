...
class ElementHandle extends \Nesk\Puphpeteer\Puppeteer\JSHandle
{
    /**
    ...
    /**
     * @param array{x: int|float, y: int|float}|\Nesk\Puphpeteer\Puppeteer\ElementHandle $target
     ...
     */
    public function drag(array|\Nesk\Puphpeteer\Puppeteer\ElementHandle $target): null|array
    {
        return $this->invokeRemote(__FUNCTION__, func_get_args());
    }
    /**
     * @param \Nesk\Puphpeteer\Puppeteer\ElementHandle $target
     * @param (array{delay: int|float})|null $options
     * @return void
     */
    public function dragAndDrop(\Nesk\Puphpeteer\Puppeteer\ElementHandle $target, array|null $options = NULL): void
    {
        $this->invokeRemote(__FUNCTION__, func_get_args());
    }
    /**
    ...
    /**
     * @var \Nesk\Puphpeteer\Puppeteer\Frame
     */
    public \Nesk\Puphpeteer\Puppeteer\Frame $frame {
        get {
